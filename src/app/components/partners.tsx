      ...
      <div className="hidden flex-col items-center justify-center text-5xl text-secondary md:flex">
        <div className="flex h-screen w-full flex-col">
          <div className="flex h-1/2 w-full flex-col items-center justify-center bg-secondary px-40 text-primary">
            <div className="flex w-full flex-col justify-between lg:flex-row">
              ...
              <Link
                ...
                target="_blank"
                className="hidden items-center rounded-full bg-primary px-8 py-2 text-xl text-secondary lg:inline-flex lg:h-full lg:text-4xl">
                Register here
              </Link>
              ...
              <div className="lg:hidden">
                <Link
                  href="https://karbon.wtf/tech-s01-reg"
                  target="_blank"
                  className="items-center rounded-full bg-primary px-8 py-3 text-2xl text-secondary">
                  Register here
                </Link>
              </div>
            </div>
          ...
          <div className="flex h-[50vh] w-full flex-col items-center justify-center bg-secondary px-40 text-primary">
            <h1 className="flex w-full text-4xl lg:text-5xl">Supported By</h1>
            ...
            <div className="debug my-20 hidden w-full items-center justify-between gap-4 px-20 lg:flex xl:gap-10 xl:px-40 2xl:gap-20 2xl:px-96">
