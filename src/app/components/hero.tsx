...
export default function Hero() {
  return (
    <div className="flex h-dvh w-full snap-start flex-col items-center justify-between px-4 py-8 uppercase md:min-h-screen md:p-14">
      {/* Header */}
      <div className="b flex w-full items-center justify-between text-secondary">
        ...
        <div className="flex items-center justify-center gap-2 rounded-full border border-secondary px-2 md:gap-4 md:border-2 md:px-6 md:py-2">
          <span className="size-1 rounded-full bg-secondary md:size-3"></span>
          <span className="inline-flex items-center justify-center text-sm md:text-2xl md:font-normal">BRIEFING</span>
        </div>
      </div>
      ...
      <div className="relative mt-14 flex h-80 flex-col items-center justify-center md:mt-0 md:h-[600px] md:w-[1200px]">
        ...
        <a
          href="https://discord.gg/fP2k44We?event=1251019268456321055"
          target="_blank"
