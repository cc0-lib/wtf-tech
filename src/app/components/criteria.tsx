  ...
  return (
    <Fragment>
      <div className="hidden flex-col justify-center bg-secondary px-20 py-20 text-primary md:flex lg:px-40 lg:pb-40 lg:pt-32">
        ...
        <div className="flex items-center justify-center lg:ml-24 lg:px-32">
          <div className="flex w-96 flex-col items-start gap-3 lg:gap-6">
            {criterias.slice(0, 3).map((item, index) => (
              <div key={index} className="inline-flex items-center justify-center gap-3 font-light">
                <span className="flex w-8 justify-center lg:w-14">
                  <Image src={item.icon} width={item.width ? item.width : 40} height={40} alt="pallete" />
                </span>
                <div className="text-2xl lg:text-4xl">{item.name}</div>
              </div>
            ))}
          </div>

          <div className="flex w-[28rem] flex-col items-start gap-3 lg:gap-6">
      ...
      <div className="flex h-[50vh] flex-col items-center justify-center bg-secondary px-10 text-primary md:hidden">
        <h1 className="inline-flex w-full justify-end text-xl underline underline-offset-2 sm:text-4xl">Criteria</h1>
